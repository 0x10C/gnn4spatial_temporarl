...
class Gps(nn.Module):
    ...
    def __init__(self, feat_dim, sage_hidden_dim1, node_embedding_dim, sage_dropout,readout_hidden_dim, \
                 graph_embedding_dim, num_cats,sim_func = "dot"):
        ...
        self.readout = Readout(feat_dim, node_embedding_dim, readout_hidden_dim, graph_embedding_dim, num_cats)
